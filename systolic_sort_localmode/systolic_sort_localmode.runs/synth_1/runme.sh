...
HD_PWD='C:/Users/gaote/Desktop/systolic_sort_localmode/systolic_sort_localmode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_systolic_sort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_systolic_sort.tcl
